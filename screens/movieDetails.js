    ...
    <ScrollView>
      ...
      <View style={{backgroundColor: '#F5F6F8'}}>
        ...
        <View style={{marginTop: 35}}>
          <Text style={{textAlign: 'center'}}>Spider-Man: Homecoming</Text>
          <Text style={{textAlign: 'center'}}>Adventure, Action, Sci-Fi</Text>
        </View>
        ...
        <View>
          ...
          <View>
            <Select
              ...
              InputLeftElement={<Icon name="calendar" size={25} />}
              _selectedItem={{
                bg: 'teal.600',
        ...
        <View style={styles.boxCinemas}>
          <View>
            <Image
              ...
              style={{width: 70, height: 27, paddingHorizontal: 10}}
            />
            ...
            <View>
              ...
              <Button style={{elevation: 5}}>Book Now</Button>
              <View />
            </View>
          </View>
          <View />
